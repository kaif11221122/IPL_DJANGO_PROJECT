...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ipl_data_analyzer', '0012_delete_deliveriesdatamodel_delete_matchesdatamodel'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('match_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ipl_data_analyzer.matches')),
            ],
        ),
    ]
